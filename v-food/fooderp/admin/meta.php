...
<!-- css样式 -->
<link rel="stylesheet" type="text/css" href="<?php echo ADMIN_ASSETS_PATH;?>/plugins/jquery-notify/css/jquery.notify.css">
...
<script src="<?php echo ADMIN_ASSETS_PATH; ?>/plugins/jquery-notify/jquery.notify.js"></script>